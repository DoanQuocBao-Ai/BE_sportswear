...
import com.store.sportswear.repository.ConfirmedOrderRepository;
...
import com.store.sportswear.service.CreditCardService;
import com.store.sportswear.service.cart.CartService;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ConfirmedOrder confirmCart(ConfirmCartRequest confirmCartRequest) {
        ...
        if (cart.isPresent()) {
            ...
            creditCardService.add(new CreditCard(confirmCartRequest.getCardNumber(), confirmCartRequest.getCvv(), confirmCartRequest.getExpirationDate(),
                    confirmCartRequest.getNameAndSurname()));
